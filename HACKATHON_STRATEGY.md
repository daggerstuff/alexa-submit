...
- An optional LLM patient persona (Amazon Bedrock Converse) with JSON-mode responses, tolerant parsing, adaptive retry, and a deterministic fallback.
