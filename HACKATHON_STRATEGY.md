...
| Working demo video under three minutes | `demo.mp4` (original, 1:02, LLM persona) + `demo-v2.mp4` (re-angle, 1:33, Remotion terminal recording, deterministic 11/20 + summary + safety)                               | Publish one on YouTube/Vimeo before submission                                                                  |
